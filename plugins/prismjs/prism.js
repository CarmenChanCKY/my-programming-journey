/* PrismJS 1.29.0
https://prismjs.com/download.html#themes=prism&languages=markup+css+clike+javascript+c+csharp+cpp+css-extras+docker+git+ignore+java+json+markdown+markup-templating+n1ql+php+plsql+powershell+pug+scss+sql+swift+twig+typescript+typoscript&plugins=line-numbers+show-language+inline-color+toolbar */
var _self =
    ...
    var n =
      ...
      o = [
        function (n) {
          ...
          if (o) {
            for (
              var s = (n = o[1]).length >= 6 ? 2 : 1, e = n.length / s, t = 1 == s ? 1 / 15 : 1 / 255, i = [], a = 0;
              a < e;
              a++
            ) {
